                ...
                <div class="card card-info">
                    <div class="card-header p-2">
                        <ul class="nav nav-pills">
                            <li class="nav-item"><a class="nav-link " href="#perfilusuario" data-toggle="tab"> Perfil </a></li>
                            <li class="nav-item"><a class="nav-link active show" href="#perfildev" data-toggle="tab"> Datos Modificables </a></li> 
                        </ul>
                    </div> 
                    <div class="card-body fondomio">
                        <div class="tab-content">
                            <div class="tab-pane " id="perfilusuario">
                            ...
                            <div class="tab-pane active show " id="perfildev">
                                <form class="form-horizontal"> 
                                    ...
                                    <div class="form-group row">
                                        <label for="avatar" class="col-md-3 col-form-label text-md-right">Foto de Perfil:</label>
                                        <div class="col-sm-9">
